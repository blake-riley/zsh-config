# Generated by Powerlevel10k configuration wizard on 2024-02-17 at 13:30 EST.
...
() {
  ...
  typeset -g POWERLEVEL9K_VI_MODE_NORMAL_FOREGROUND=1
  ...
  # LOCAL_ICON=$'\UE5FC'
  # SHELL_ICON=$'\UF489'
  typeset -g POWERLEVEL9K_PYENV_VISUAL_IDENTIFIER_EXPANSION=$'\UF81F'
